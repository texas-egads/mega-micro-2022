...
public interface IMinigamesManager
{
    ...
    /// <summary>
    /// Call this when you want your minigame to end early. A good time to do this would be after
    /// a win or lose animation finishes, when the player already knows the final outcome of the
    /// minigame. If you do not call EndCurrentMinigame during your minigame time, the minigame
